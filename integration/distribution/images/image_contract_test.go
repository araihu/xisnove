...
func TestNativeImagesHonorRuntimeAndSupplyChainContract(t *testing.T) {
	if os.Getenv("XISNOVE_REQUIRE_NATIVE_IMAGES") != "1" {
		t.Skip("native image contract requires images built by the distribution gate")
	}
	...
	for name, entrypoint := range images {
		t.Run(name, func(t *testing.T) {
			...
			for _, want := range []string{
				...
				"3e070f4f594a3d97af28e694792dc3af63a15c9bb2b592648b7f48b852e0292f  /usr/share/licenses/xisnove/NOTICE",
				"glibc 2.35",
			} {
