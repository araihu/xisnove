...
The authenticated console shell uses the frozen X-9 logo and favicon from
...
The authenticated shell consumes the full logo through Goshtoso's managed
brand slot; the mark variants remain staged for icon and dark-surface uses.
