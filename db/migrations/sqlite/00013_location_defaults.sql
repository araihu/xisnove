...
ALTER TABLE locations ADD COLUMN default_interval_ms INTEGER NOT NULL DEFAULT 60000
    CHECK (default_interval_ms > 0);
ALTER TABLE locations ADD COLUMN default_timeout_ms INTEGER NOT NULL DEFAULT 5000
