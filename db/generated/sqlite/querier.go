...
type Querier interface {
	...
	GetAgentLastCompleteDiscovery(ctx context.Context, id string) (sql.NullString, error)
	...
	ManagementGetCurrentAgentCredential(ctx context.Context, id string) (AgentCredential, error)
